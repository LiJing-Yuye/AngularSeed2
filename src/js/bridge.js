...
function updateISCInfo() {
    broadcast('updateISCInfo', arguments)
}
function currentWifiChanged() {
    broadcast('currentWifiChanged', arguments)
}
function ScanErrorHandle() {
