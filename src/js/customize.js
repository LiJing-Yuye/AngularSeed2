...
(function () {
    ...
    if (locale == "JA-JP") {
        ...
        wordingJson["imagePromoteDiamond"] = "https://drs2-client-conf.s3-us-west-1.amazonaws.com/drs-client-conf/DiamondPromoteImage_JP.png" 
        ...
        wordingJson["imagePromoteDiamond"] = "https://drs2-client-conf.s3-us-west-1.amazonaws.com/drs-client-conf/DiamondPromoteImage.png"
    ...
    wordingJson.DRSSupportER =
        "http://gr.trendmicro.com/GREntry/NonPayment?Target=support_drs&OS=&SP=&PID=&FunID=#1&VID=&Locale=" + locale;
    wordingJson.ISCIKBLink =
        "http://gr.trendmicro.com/GREntry/NonPayment?Target=iKB_ISC&OS=&SP=&PID=&FunID=#1&VID=&Locale=" + locale;
    ...
    var changeWordingMap = {
        Windows: {
            "EN-US": {
                GDPRPageDCNURL: wordingJson.DRSSupportER.replace("#1", "GDPR_Win"),
                GDPRPagePolicyURL:
        ...
        Mac: {
            "EN-US": {
                GDPRPageDCNURL: wordingJson.DRSSupportER.replace("#1", "GDPR_Mac"),
                GDPRPagePolicyURL:
    ...
    changeWording = changeWordingMap[PLATFORM][locale];
...
getDiamondPromotion = function (param) {
