...
function NotificationEN(type) {
    if (type == 200005) {
        url =
            'http://localhost/win/NotificationPage.html?debug&data={%22popup_type%22:200005,%22data%22:{%22network_name%22:%22tset%22,%22has_success_scaned%22:false,%22is_current_network%22:true,%22gateway_mac%22:%22test%22}}'
    } else {
        url =
            'http://localhost/win/NotificationPage.html?debug&data={%22popup_type%22:' +
            type +
            ',%22data%22:{%22device_ip_list%22:[%2212345%22]}}'
    }
...
function NotificationJP(type) {
    if (type == 200005) {
        url =
            'http://localhost/win/NotificationPage.html?debug&lang=JA_JP&data={%22popup_type%22:200005,%22data%22:{%22network_name%22:%22tset%22,%22has_success_scaned%22:false,%22is_current_network%22:true,%22gateway_mac%22:%22test%22}}'
    } else {
        url =
            'http://localhost/win/NotificationPage.html?debug&lang=JA_JP&data={%22popup_type%22:' +
            type +
            ',%22data%22:{%22device_ip_list%22:[%2212345%22]}}'
    }
